    ...
    hooks: {
      'config:setup'({ config, logger, updateConfig }) {
        ...
        updateConfig({
          ...
          customCss: [
            ...(config.customCss ?? []),
            'starlight-theme-visa/styles/fonts',
          ...
          expressiveCode:
            config.expressiveCode === false
              ...
              : {
                  ...
                  styleOverrides: {
                    borderColor: 'var(--sl-visa-ui-border-color)',
                    borderRadius: '0.5rem',
                    ...
                    frames: {
                      ...
                      editorTabBarBorderBottomColor: 'var(--sl-visa-ui-border-color)',
                      frameBoxShadowCssValue: 'unset',
                      ...userExpressiveCodeConfig.styleOverrides?.frames,
                    },
                    textMarkers: {
                      backgroundOpacity: '40%',
                      markBackground: 'var(--sl-visa-ec-marker-bg-color)',
                      markBorderColor: 'var(--sl-visa-ec-marker-border-color)',
