...
description: Learn how to use the Starlight Visa theme in your documentation.
---

A [Starlight](https://starlight.astro.build) theme inspired by Visa Docs.
...
1. The Starlight Visa theme is a Starlight [plugin](https://starlight.astro.build/reference/plugins/) that you can install using your favorite package manager:

   <PackageManagers pkg="starlight-theme-visa" />
...
That's it! You should now see the Starlight Visa theme applied to your Starlight website.
